...
- Deliver Immich and its version-compatible database/cache/ML dependencies, Jellyfin, Radarr, Sonarr, Prowlarr, SABnzbd, and Seerr through reusable Nix-rendered application definitions on the existing unprivileged Incus/K3s compute boundary. Prefer Sini's Den/Nixidy/chart composition over extending custom packaging.
