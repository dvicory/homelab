...
| Prowlarr | Same app-template shape and pinned image as the Arr applications, retained local configuration and no media paths. Radarr and Sonarr consume its indexer API over the internal service; production indexer credentials stay out of scope. |
