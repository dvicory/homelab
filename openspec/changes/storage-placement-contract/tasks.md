Host-owned semantic-root declarations and their ACL/identity checks are complete.
Pooling, consumer repointing, placement checks, and production validation remain
open; production data has not been migrated.
