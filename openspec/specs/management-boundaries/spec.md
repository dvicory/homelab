...
Homelab MAY define the availability, recovery, security, or integration properties that wider Homelab operation requires from a workload or service. Such an operational contract SHALL remain limited to those system-facing properties unless ownership of the dependency's internal implementation is explicitly transferred.
